...
export interface ISnowDragonConnectorConfigState extends ITeamsBaseComponentState {
...
export interface ISnowDragonConnectorConfigProps extends ITeamsBaseComponentProps {
}
...
/**
 * Implementation of the snowDragonConnector Connector connect page
 */
export class SnowDragonConnectorConfig extends TeamsBaseComponent<ISnowDragonConnectorConfigProps, ISnowDragonConnectorConfigState> {
        ...
        if (this.inTeams()) {
            ...
            microsoftTeams.settings.registerOnSaveHandler((saveEvent: microsoftTeams.settings.SaveEvent) => {
                ...
                const settings: any = {
                    ...
                    contentUrl: `https://${process.env.HOSTNAME}/snowDragonConnector/config.html`,
