...
export interface ISnowDragonTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ISnowDragonTabRemoveProps extends ITeamsBaseComponentProps {

}

/**
 * Implementation of Snow Dragon Tab remove page
 */
export class SnowDragonTabRemove  extends TeamsBaseComponent<ISnowDragonTabRemoveProps, ISnowDragonTabRemoveState> {
