...
3. Give the bot a handle (ex: `snowDragonBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://snowdragon.azurewebsites.net/api/messages`
